...
namespace ApiCatalogoJogos.Services
{
    public class JogoService : IJogoService
    {
        ...
        public async Task Atualizar(Guid id, double preco) //Atualiza somente o preço do jogo
        {
            var entidadeJogo = await _jogoRepository.Obter(id);
        ...
        public void Dispose()
        {
            _jogoRepository?.Dispose();  //Fechar conexão com o banco
        }
    }
}
