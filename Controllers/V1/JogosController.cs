...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpPut("{idJogo:guid}")] // HttpPut: atualiza o recurso inteiro
        ...
        /// <response code="404">Caso não exista um jogo com este Id</response>
        [HttpPatch("{idJogo:guid}/preco/{preco:double}")] // HttpPatch: atualiza somente um atributo do recurso
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromRoute] double preco) //Atualiza somente o preço do jogo
        {
            try
            {
